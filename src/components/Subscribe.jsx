        ...
        >
          <form action="" className="flex flex-col gap-2 text-black">
            <div className="w-[350px] flex flex-col gap-2">
              <label
                htmlFor=""
                className="text-green-500 font-semibold cursor-pointer text-lg"
              >
                Name
              </label>
              <input
                ...
                className="w-full outline-none border rounded-md bg-slate-300 py-1 px-4 text-black"
              />
            </div>
            <div className="w-[350px] flex flex-col gap-2">
              <label
            ...
            <div className="w-[350px] h-[200px] ">
              <textarea
                ...
                className="w-full outline-none h-full border rounded-md bg-slate-300 py-1 text-black px-4"
              />
            </div>
            <button
              className="bg-green-500 w-[350px] h-[30px] cursor-pointer rounded-md
